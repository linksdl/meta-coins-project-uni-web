 ...
 * @date 2019年8月18日
 */
@Table(name="pfp_config_category_consume")
@Entity
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class CategoryConsume extends BaseEntity {
	...
	private String  categoryType;   // 分类类型（支出，收入）
	...
	/** 子分类 */
	@Transient
    private List<CategoryConsume> children = new ArrayList<CategoryConsume>();
}
